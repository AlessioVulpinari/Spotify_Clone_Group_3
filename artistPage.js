const URL = "https://deezerdevs-deezer.p.rapidapi.com/artist/eminem";
...
fetch(
  " https://striveschool-api.herokuapp.com/api/deezer/artist/13/top?limit=10",
  {
    method: "GET",
  }
)
  ...
  .then((obj) => {
    obj.data.forEach((element) => {
      ...
      row.innerHTML = `
    <div class="col-1 text-secondary text-end p-0">
        <span>1</span>
    </div>
    <div class="col-6">
    ...
    <div class="col-3 text-secondary">${element.rank}</div>
    <div class="col-2 text-secondary">${element.duration}</div>
`;
